% Estimate 11: Ind + Asymmetric + Sqr
...
Q_mat_risk(:,:,3) = VExp_mat(:, 2:end);

Q_mat_risk_sqr(:,:,1) = MExp_mat(:, 1:route_max)+0.6;
Q_mat_risk_sqr(:,:,2) = Q_mat_risk_sqr(:,:,1).^2;
Q_mat_risk_sqr(:,:,3) = repmat(VExp_mat(:, 1), 1, route_max);
Q_mat_risk_sqr(:,:,4) = VExp_mat(:, 2:end);
...
Q_mat_asy_risk(:,:,4) = VExp_mat(:, 2:end);
...
Q_mat_asy_risk_sqr(:,:,1) = MExp_mat(:, 1:route_max).*(MExp_mat(:, 1:route_max)>=0)-0.25;
Q_mat_asy_risk_sqr(:,:,2) = MExp_mat(:, 1:route_max).*(MExp_mat(:, 1:route_max)<0) + 0.57;
...
Q_mat_asy_risk_sqr(:,:,6) = VExp_mat(:, 2:end);
...
Q_mat_asy_sqr(:,:,1) = MExp_mat(:, 1:route_max).*(MExp_mat(:, 1:route_max)>=0)-0.226;
Q_mat_asy_sqr(:,:,2) = MExp_mat(:, 1:route_max).*(MExp_mat(:, 1:route_max)<0) + 0.494;
