% Estimate 16: Learning_Pool.mat + asymmetric + sqr + risk (phi , xi)
...
% nvip = 60; %can adjust this sample value
...
X = cat(3, Q_mat_asy_risk_sqr, X, ones(size(Q_mat,1),size(Q_mat,2),1));
